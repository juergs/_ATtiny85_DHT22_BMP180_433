...
#ifdef BOARD_TYP_1
#define SENSOR_PIN			3	  //  D3 / PIN2 
#define TX_433_PIN          4     //  D4 / PIN3 	- PIN_SEND in LaCrosse.cpp
#else
...
//*********************************************
#define SENSORID			121					// MaxID = 127 (!), Sensor-ID wird in Setup-Methode gesetzt!
//*********************************************
#define DHT22_PIN			SENSOR_PIN
//*********************************************

//VSMicro-Setting?
//_ATtiny85_DHT22_433_New.ino:201 : 57 : error : 'Serial' was not declared in this scope
//void setup() {
...
#define BOOL_USE_SOFTWARE_SERIAL FALSE
